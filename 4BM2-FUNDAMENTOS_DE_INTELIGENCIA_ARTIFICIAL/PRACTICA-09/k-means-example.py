...
plot.xlabel('Ofensiva')
plot.ylabel('Defensiva')
plot.title('K-Means Clustering Ofensiva vs Defensa')
plot.grid(color='gray', linestyle='--', linewidth = 0.5)
plot.show()


dataframe.to_csv('spi_global_rankings_Clustering.csv', encoding='ISO-8859-1')